...
<div class="">
  <div class="w3-bar w3-light-grey w3-large">
    <a href="#" class="w3-bar-item w3-button w3-hover-red w3-padding-16"><img src="imgs/Logo.png" id="Lg"></a>
 ...
 <div class="w3-container w3-card-4 w3-light-grey w3-text-pink" style="width: 100%; height: 300px;">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" style="margin-top:100px;margin-bottom:60px;">
    <div class="w3-quarter">
      <img src="imgs/Croiasant.jpg" alt="Sandwich" style="width:100%">
      <h3>Our Vision</h3>
      <p>To create a more educated and sophisticated Jordan.</p>
    </div>
    <div class="w3-quarter">
      <img src="imgs/View.jpg" alt="Steak" style="width:100%;height:240px;">
      <h3>Our Mission</h3>
      <p>To improve the literacy and education of the Youth.</p>
    </div>
    <div class="w3-quarter">
      <img src="imgs/reading.jpg" alt="Cherries" style="width:100%;height:240px">
      <h3>Our Values</h3>
      <p>At Plotbound, Diversity and diffrence are always put to a higher standard.</p>
    </div>
    <div class="w3-quarter">
      <img src="imgs/team.jpg" alt="Pasta and Wine" style="width:100%">
      <h3>Our Team</h3>
